...
@Autonomous(name = "All Levels Red Right")
public class AllLevelsRedRight extends OmniBotAuto {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        deliverMidAndLow(Quadrant.RED_RIGHT, -1);

        /*
         * Drive back to color tape, turn to position, and drive to cone stack.
         */
        driveTapeToStack45(Quadrant.RED_RIGHT, xOffset, 90, -350);
